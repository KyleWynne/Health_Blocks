...
const exercise_input = "I ran 3 miles";
...
const nutritionix_input = "I ate 3 apples";
...
.then(response => response.json())
.then(data => { return data; }) // Return the data instead of logging it//.then(data => console.log(data)) //comment this line in when running on the console
.catch(error => console.error("Error:", error));
const foodName = "big mac"; // Replace with the food you want to search for
